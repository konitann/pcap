...
int finddev(char **xdev, pcap_if_t  **xifp)
{
...
void analyze(u_char *user, const struct pcap_pkthdr *pkhdr, const u_char *pktdata)
{
    static int cnt=0;
...
int timerloop(pcap_t *phand, int waittime)
{
    struct pcap_pkthdr *pkthdr;
    u_char *pktdata;
    int     ck;
